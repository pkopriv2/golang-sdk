...
func (e *log) NewSnapshot(cancel <-chan struct{}, lastIndex int64, lastTerm int64, ch <-chan Event, config Config) (StoredSnapshot, error) {
	return e.storage.Store().NewSnapshot(cancel, lastIndex, lastTerm, ch, config)
}
